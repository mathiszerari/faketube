...
<template>
  ...
  <div class="container bg-gray-900">
    ...
    <div class="flex justify-center items-center">
      ...
      <div class="div-input w-1/2 mt-5 mx-auto relative">
    ...
    <div v-if="msg.length > 0 && clear === true" class="suggestion-container flex justify-center items-center relative">
      <div class="suggestion w-1/2 mt-1 bg-gray-700 pr-15 rounded-xl pb-3">
  ...
  <div class="bg-gray-100 h-64 w-64">aaaa</div>
</template>
